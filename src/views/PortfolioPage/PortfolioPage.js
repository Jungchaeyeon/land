        ...
        <section className="container">
            <form className="milliewillie">
                ...
                <form className="appIntro">
                    ...
                    <video className="video" muted autoPlay loop style={{width:'20%',height:'20%', marginTop:'30px'}}>
                ...
                <br /></ul>
                    ...
                    <a style={{ marginTop:'30px'}} href="https://github.com/Jungchaeyeon/FallPrevention">github 프로젝트 바로가기</a>
                </form>
                <form className="appIntro">
                ...
                <br /></ul>
                    ...
                    <div style={{ marginTop: "30px"}}>
                        <img src="toy1.png" style={{width:'10%',height:'10%',marginRight:'15px' }}/>
                        <img src="toy3.png" style={{width:'10%',height:'10%', marginRight:'15px'}}/>
                        <img src="toy2.png" style={{width:'10%',height:'10%',marginRight:'15px'}}/>
                    </div>
